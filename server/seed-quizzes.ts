...
const dictation: Question = { id: 'greeting-dictation', kind: 'dictation', prompt: l('Послушайте и запишите иероглифами услышанное приветствие.', 'Тыңдап, естіген сәлемдесуді иероглифтермен жазыңыз.', 'Listen and write the greeting in Chinese characters.'), accepted: ['你好'], explanation: l('В записи звучит 你好 — «здравствуйте».', 'Жазбада 你好 — «сәлеметсіз бе» айтылады.', 'The recording says 你好, meaning hello.'), audioUrl: 'https://upload.wikimedia.org/wikipedia/commons/7/7d/Zh_n%C7%90_h%C7%8Eo.ogg', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Zh_n%C7%90_h%C7%8Eo.ogg', author: 'Sjors Provoost', license: 'CC BY-SA 3.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0/' };
const match: Question = { id: 'name-match', kind: 'match', prompt: l('Сопоставьте слова и перевод.', 'Сөздер мен аудармаларын сәйкестендіріңіз.', 'Match the words to their meanings.'), left: [option('wo', '我'), option('jiao', '叫'), option('mingzi', '名字')], right: [option('name', 'имя', 'есім', 'name'), option('me', 'я', 'мен', 'I'), option('called', 'зваться', 'аталу', 'to be called')], correct: ['me', 'called', 'name'], explanation: l('我 — я; 叫 — зваться; 名字 — имя.', '我 — мен; 叫 — аталу; 名字 — есім.', '我 means I; 叫 means to be called; 名字 means name.') };
const gap: Question = { id: 'name-gap', kind: 'gap', prompt: l('Заполните пропуск одним иероглифом: 我 ___ 安娜。', 'Бос орынды бір иероглифпен толтырыңыз: 我 ___ 安娜。', 'Fill the gap with one character: 我 ___ 安娜。'), accepted: ['叫'], explanation: l('我叫安娜 означает «Меня зовут Анна».', '我叫安娜 — «Менің атым Анна».', '我叫安娜 means My name is Anna.') };
const order: Question = { id: 'name-order', kind: 'order', prompt: l('Соберите вопрос «Как вас зовут?»', '«Атыңыз кім?» сұрағын құрастырыңыз.', 'Build the question What is your name?'), options: [option('name', '名字'), option('you', '你'), option('what', '什么'), option('called', '叫')], correct: ['you', 'called', 'what', 'name'], explanation: l('Правильный порядок: 你叫什么名字？', 'Дұрыс реті: 你叫什么名字？', 'The correct order is 你叫什么名字？') };
const nameInput: Question = { id: 'name-input', kind: 'input', prompt: l('Напишите «имя» иероглифами.', '«Есім» сөзін иероглифтермен жазыңыз.', 'Write name in Chinese characters.'), accepted: ['名字'], explanation: l('名字 (míngzi) — имя.', '名字 (míngzi) — есім.', '名字 (míngzi) means name.') };
const thanks: Question = { id: 'thanks-choice', kind: 'choice', prompt: l('Что ответить на 谢谢?', '谢谢 сөзіне қалай жауап береді?', 'How do you respond to 谢谢?'), options: [option('hello', '你好'), option('welcome', '不客气'), option('name', '名字')], correct: 'welcome', explanation: l('不客气 — вежливый ответ на благодарность.', '不客气 — алғысқа сыпайы жауап.', '不客气 is a polite response to thanks.') };
const goodbye: Question = { id: 'goodbye-input', kind: 'input', prompt: l('Напишите «до свидания» иероглифами.', '«Сау болыңыз» сөзін иероглифтермен жазыңыз.', 'Write goodbye in Chinese characters.'), accepted: ['再见'], explanation: l('再见 (zàijiàn) — до свидания.', '再见 (zàijiàn) — сау болыңыз.', '再见 (zàijiàn) means goodbye.') };
